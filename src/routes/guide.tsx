...
export const Route = createFileRoute("/guide")({
  head: () => ({
    meta: [
      { title: "The 11 Steps to File a Cyber Crime Complaint | SafeTrace" },
      {
        name: "description",
        content:
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-14">
      ...
      <p className="mt-4 text-lg text-muted-foreground">
        This is the process on India's National Cyber Crime Reporting Portal. SafeTrace prepares
      ...
      <div className="panel mt-10 flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-sm text-muted-foreground">
          Let SafeTrace prepare your category, description and evidence list first.
        </p>
