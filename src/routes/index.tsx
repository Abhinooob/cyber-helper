...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Cyber Helper — Report Cyber Fraud in India, Step by Step" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Cyber Helper — Cyber Fraud Reporting Assistant" },
      {
    ...
    <div>
      <section className="mx-auto max-w-6xl px-4 pt-14 pb-10 md:pt-20">
        ...
        <p className="mt-5 max-w-2xl text-lg text-muted-foreground">
          Cyber Helper walks you through the official reporting process, organises your evidence and
      ...
      <section className="mx-auto max-w-6xl px-4 py-10">
        <h2 className="text-2xl font-semibold md:text-3xl">How Cyber Helper fits in</h2>
        <p className="mt-2 max-w-2xl text-muted-foreground">
          Cyber Helper never files your complaint and never asks for your ID or OTP. It prepares
          ...
          {[
            {
              ...
              body: "Answer a few plain questions and Cyber Helper picks the right route — Financial Fraud or Other Cyber Crime.",
              to: "/report" as const,
              cta: "Assess my case",
            },
            {
